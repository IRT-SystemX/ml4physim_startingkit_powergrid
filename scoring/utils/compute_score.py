...
def compute_global_score(metrics):
    ...
    return globalScore, test_ml_subscore, test_physics_subscore, test_ood_ml_subscore, test_ood_physics_subscore, speedup_score, speed_up, test_results_disc, test_ood_results_disc
